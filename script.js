...
(function codeTypewriter() {
    ...
    const lines = [
        { t: '<c>// from zero...</c>' },
        { t: '<k>const</k> <v>student</v> = <k>new</k> <f>VefskolinnStudent</f>({' },
        { t: '  <v>level</v>: <s>"beginner"</s>,' },
        { t: '  <v>curiosity</v>: <n>100</n>,' },
        { t: '  <v>caffeine</v>: <n>9999</n>,' },
        { t: '});' },
        { t: '' },
        { t: '<c>// 8 modules later...</c>' },
        { t: '<k>await</k> <v>student</v>.<f>learn</f>([' },
        { t: '  <s>"HTML"</s>, <s>"CSS"</s>, <s>"JavaScript"</s>,' },
        { t: '  <s>"UX/UI"</s>, <s>"Frameworks"</s>, <s>"Backend"</s>,' },
        { t: '  <s>"Teamwork"</s>, <s>"Design Thinking"</s>' },
        { t: ']);' },
        { t: '' },
        { t: '<k>await</k> <v>student</v>.<f>internship</f>({ <v>weeks</v>: <n>12</n> });' },
        { t: '' },
        { t: '<c>// ...to hero</c>' },
        { t: '<k>return</k> <v>student</v>.<f>shipIt</f>(<s>"🚀"</s>);' },
    ];
